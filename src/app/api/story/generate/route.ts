...
## 认知来源清晰性（!!!最严格!!!）
科学结论的来源必须清晰、可信，不能通过想象得出科学事实！

### 错误示例（❌ 禁止）：
- ❌ "他想象自己变小进入身体，在想象中发现了..." —— 想象世界不等于真实发现
- ❌ "他梦到进入肚子，看到了胃液..." —— 梦境不是科学观察
- ❌ "他幻想自己变成细胞，在细胞世界里..." —— 幻想不能得出真实科学结论

### 正确方式（✅）：
- ✅ 主角通过实际操作/实验观察到现象：敲敲瓶子听声音、把手放在肚子上感受振动
- ✅ 主角通过外部工具/设备观察：使用听诊器、显微镜、望远镜
- ✅ 主角通过生活经验总结规律：按时吃饭后肚子不叫了、摸到肚子软硬的区别
- ✅ 主角通过对比发现：空腹时咕噜声大，吃饱后声音小

### 核心原则：
- 想象/幻想/梦境 = 故事装饰，不能作为科学知识的来源
- 科学结论必须来自：真实观察 → 合理推理 → 得出结论

## 科学幻想的边界
- ✅ 允许科学幻想作为故事框架（进入细胞、变成小不点等），但科学知识点本身必须来自真实观察
- ❌ 但必须有科学框架合理性
- ❌ 禁止"钻进血管看看"——这不科学，无法操作
...
# 知识点引出方式（!!!最严格的规定!!!）
禁止以下所有"被告知"式套路和"想象发现"式套路：
- ❌ 禁止"想起爸爸说过/妈妈说过/老师说过/爷爷说过"
- ❌ 禁止"他记得一本书上写着/说明书上写着/百科全书里说"
- ❌ 禁止"突然，一个声音说..."（突然冒出个解说员）
- ❌ 禁止"爸爸解释/妈妈解释/老师解释/专家解释"
- ❌ 禁止"他想象自己变小，进入了..." —— 想象世界不能得出真实科学结论
- ❌ 禁止"他梦到..." —— 梦境不是科学观察
- ❌ 禁止"在想象中，他看到..." —— 必须通过真实方式发现知识

正确方式：知识必须通过主角的真实观察和体验来发现！
- ✅ 主角动手操作时"意外"发现原理
- ✅ 主角观察到现象后"自己推理"出原因
- ✅ 主角遇到困难时"偶然发现"解决办法
- ✅ 主角的某个动作"正好"触发了科学现象
...
- 错误：肚子咕噜叫，他想象自己变小进入肚子，发现了胃在蠕动（❌ 想象不是真实观察）
- 正确：肚子咕噜叫，他用手摸肚子感觉振动，听诊器听到声音，对比吃饭前后区别，发现了规律（✅ 真实观察+推理）

- **技巧**：让科学现象直接作用于故事角色——星星"逃跑"是因为孩子在观察，光合作用"发生"在孩子救活小苗的瞬间，地震是孩子脚下的震动。通过主角的五官感受、动作反应来呈现知识。肚子咕噜叫不是因为"想象进入肚子"，而是用手摸、用耳听、对比吃饭前后的真实体验。
...
- **技巧**：让科学现象直接作用于故事角色——机器人罢工是因为传感器没电了，程序出错是因为主角写错了代码。让主角用五官去感受，用双手去操作，用失败来学习。肚子咕噜叫不是因为"想象进入肚子"，而是用手摸、用耳听、对比吃饭前后的真实体验。
